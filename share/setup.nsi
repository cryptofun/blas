...
!define URL http://www.BlakeStar.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/BlakeStar.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\BlakeStar-qt.exe
...
OutFile BlakeStar-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/BlakeStar-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/BlakeStard.exe
    ...
    #Delete /REBOOTOK $INSTDIR\BlakeStar.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\BlakeStar-qt.exe
