...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/BlakeStar"));
    setWindowIcon(QIcon(":icons/BlakeStar"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BlakeStar address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/BlakeStar"), tr("&About BlakeStar"), this);
    aboutAction->setToolTip(tr("Show information about BlakeStar"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for BlakeStar"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/BlakeStar"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/BlakeStar_testnet"));
            setWindowIcon(QIcon(":icons/BlakeStar_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/BlakeStar_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BlakeStar client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BlakeStar client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BlakeStar network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BlakeStar address or malformed URI parameters."));
    }
