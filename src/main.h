...
static const int64_t MAX_MONEY = 2400000000 * COIN;
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int64_t COIN_YEAR_REWARD = 10 * CENT;
static const int64_t COIN_YEAR_REWARD2 = 200 * CENT;
...
inline bool IsBlakeStarV2ChainFix(int nHeight) { return TestNet() || nHeight > 90000; }
